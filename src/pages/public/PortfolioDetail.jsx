...
const PortfolioDetail = () => {
  ...
  const project = projects.find(p => p.slug === slug && p.active)
  ...
  return (
    <div className="pt-24 pb-20">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <Link to="/portfolio" className="inline-flex items-center space-x-2 text-gray-600 dark:text-gray-400 hover:text-brand-600 dark:hover:text-brand-400 mb-8 transition-colors">
          ...
          <div className="relative rounded-2xl overflow-hidden mb-10">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-10">
              ...
              <h1 className="brand-gradient-text-strong text-3xl lg:text-4xl font-bold">{project.title}</h1>
            </div>
          </div>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {project.fullCaseStudy && (
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 leading-relaxed">{project.fullCaseStudy}</p>
                </div>
              )}
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.map((tech, index) => (
                      <span key={index} className="px-4 py-2 bg-brand-100 dark:bg-brand-900/30 text-brand-700 dark:text-brand-300 font-medium rounded-full">
                        {tech}
                      </span>
                    ))}
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-gray-900 dark:text-white">{project.category}</p>
                    </div>
                  </div>
                  ...
                  {project.completionDate && (
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-gray-900 dark:text-white">{formatDate(project.completionDate)}</p>
                      </div>
                    </div>
                  )}
                </div>
