...
const initialSettings = {
  company: {
    ...
    description: 'Hi Grove Technologies is a modern technology company serving businesses, organizations and individuals in Tirunelveli, Melapalayam, Pirancheri and across South Tamil Nadu with scalable digital solutions.',
    logo: null,
    favicon: null
  },
  contact: {
  ...
  seo: {
    ...
    metaDescription: 'Hi Grove Technologies is a technology company serving Tirunelveli, Melapalayam, Pirancheri and South Tamil Nadu with website development, e-commerce, custom web applications, UI/UX design and SEO solutions.',
    keywords: 'Hi Grove Technologies, Hi Grove, Grove, Technologies, Technology in Tirunelveli, Top Tech Company in Tirunelveli, technology company in Tirunelveli, Tirunelveli, Melapalayam, Pirancheri, Nellai, South Tamil Nadu, web development company in Tirunelveli, website development, e-commerce development, custom web development, UI UX design, SEO optimization, MERN Stack development, PERN Stack development, full stack web development, Mani, Riyas, Saleem, Irsath',
...
export const DataProvider = ({ children }) => {
  ...
  const refreshFromCloud = async () => {
    ...
    let content
    try {
      content = await getAllContent(contentKeys)
    } catch (error) {
      // Never treat a temporary Supabase/RLS/network failure as an empty
      // database. Doing so could incorrectly trigger the local-to-cloud
      // migration path and overwrite remote content.
      console.error('[Hi Grove] Failed to read Supabase content:', error)
      return
    }
